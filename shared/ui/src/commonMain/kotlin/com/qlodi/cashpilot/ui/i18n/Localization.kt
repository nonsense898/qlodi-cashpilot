...
class CashStrings {
    ...
    var counterparty = ""
    var exportCsv = ""; var exportEmpty = ""
    var noResults = ""; var noResultsSub = ""
    ...
    var csvNoRows = ""; var csvSkippedFmt = ""
    // taxes
...
private fun en() = CashStrings().apply {
    ...
    exportCsv = "Export CSV"; exportEmpty = "Nothing to export"
    noResults = "No matches"; noResultsSub = "Try a different search term."
    ...
    csvNoRows = "No rows recognized in the file. Expected columns: date, amount, description (date as 2026-06-30 or 30.06.2026)."
    ...
    empFop = "Sole proprietor (FOP)"; empEsvOverride = "SSC rate override, %"
...
private fun uk() = CashStrings().apply {
    ...
    exportCsv = "Експорт CSV"; exportEmpty = "Немає що експортувати"
    noResults = "Нічого не знайдено"; noResultsSub = "Спробуйте інший запит."
    ...
    csvNoRows = "У файлі не розпізнано жодного рядка. Очікувані колонки: дата, сума, опис (дата у форматі 2026-06-30 або 30.06.2026)."
    ...
    empFop = "ФОП"; empEsvOverride = "Ставка ЄСВ, %"
    runPayrollBtn = "Нарахувати зарплату"; payrollRuns = "Розрахункові цикли"; noEmployees = "Працівників ще немає"
    grossCol = "Gross"; netCol = "На руки"; payrollPosted = "Проведено в журнал"
    ...
    reportsSub = "Деривуються з журналу"; trialBalance = "Оборотно-сальдова"; balanceSheet = "Баланс"; accountCol = "Рахунок"
